/**
 * Centralized URL configuration for Agent-M (CommonJS version for Electron)
 ...
 */
function getBackendUrl(settings = null) {
 ...
 */
function getAiApiUrl(settings = null) {
